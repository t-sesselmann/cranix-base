...
mv /opt/cranix-java/conf/oss-api.properties /opt/oss-java/conf/oss-api.properties-orig
mv /var/lib/printserver/ /var/lib/printserver-orig
mv /etc/cups /etc/cups-orig

scp old-oss:/root/.my.cnf /root/.my.cnf
scp old-oss:/opt/cranix-java/conf/oss-api.properties /opt/oss-java/conf/oss-api.properties
