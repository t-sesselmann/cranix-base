...
CREATE TABLE IF NOT EXISTS `Partitions` (
	...
	CONSTRAINT fk_partitions_hwconfs FOREIGN KEY(hwconf_id) REFERENCES HWConfs(`id`) ON DELETE CASCADE,
	PRIMARY KEY  (`id`)
);
...
CREATE TABLE IF NOT EXISTS `Rooms` (
	...
	CONSTRAINT fk_rooms_hwconfs FOREIGN KEY(hwconf_id) REFERENCES HWConfs(`id`) ON DELETE CASCADE,
	PRIMARY KEY  (`id`)
);
...
CREATE TABLE IF NOT EXISTS `Devices` (
	...
	CONSTRAINT fk_devices_rooms   FOREIGN KEY(room_id)   REFERENCES Rooms(`id`)   ON DELETE CASCADE,
	CONSTRAINT fk_devices_hwconfs FOREIGN KEY(hwconf_id) REFERENCES HWConfs(`id`) ON DELETE CASCADE,
	PRIMARY KEY  (`id`)
);
...
CREATE TABLE IF NOT EXISTS `AccessInRoom` (
	...
	CONSTRAINT fk_accessinroom_rooms FOREIGN KEY(room_id) REFERENCES Rooms(`id`) ON DELETE CASCADE,
	PRIMARY KEY  (`id`)
);
...
CREATE TABLE IF NOT EXISTS `LoggedOn` (
	...
	CONSTRAINT fk_loggedon_users         FOREIGN KEY(user_id)         REFERENCES Users(`id`)         ON DELETE CASCADE,
	CONSTRAINT fk_loggedon_devices  FOREIGN KEY(device_id)  REFERENCES Devices(`id`)  ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS `DefaultPrinters` (
	`room_id`        INT UNSIGNED NOT NULL,
	`device_id` INT UNSIGNED NOT NULL,
	CONSTRAINT fk_defaultprinters_rooms         FOREIGN KEY(room_id) REFERENCES Rooms(`id`) ON DELETE CASCADE,
	CONSTRAINT fk_defaultprinters_devices  FOREIGN KEY(device_id)  REFERENCES Devices(`id`)  ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS `AvailablePrinters` (
	...
	`room_id`        INT UNSIGNED NOT NULL,
	`device_id` INT UNSIGNED NOT NULL,
	CONSTRAINT fk_availableprinters_rooms         FOREIGN KEY(room_id) REFERENCES Rooms(`id`) ON DELETE CASCADE,
	CONSTRAINT fk_availableprinters_devices  FOREIGN KEY(device_id)  REFERENCES Devices(`id`)  ON DELETE CASCADE,
	PRIMARY KEY  (`id`)
);
...
CREATE TABLE IF NOT EXISTS  `Tests` (
	...
	CONSTRAINT fk_tests_users FOREIGN KEY(teacher_id) REFERENCES Users(`id`) ON DELETE CASCADE,
	CONSTRAINT fk_tests_rooms FOREIGN KEY(room_id)    REFERENCES Rooms(`id`) ON DELETE SET NULL,
	PRIMARY KEY  (`id`)
);
...
CREATE TABLE IF NOT EXISTS TestFiles (
	...
	CONSTRAINT fk_testfiles_tests FOREIGN KEY(test_id) REFERENCES Tests(`id`) ON DELETE CASCADE,
	CONSTRAINT fk_testfiles_users FOREIGN KEY(user_id) REFERENCES Users(`id`) ON DELETE CASCADE,
	PRIMARY KEY  (`id`)
);
...
CREATE TABLE IF NOT EXISTS TestUsers (
	...
	CONSTRAINT fk_testusers_tests FOREIGN KEY(test_id) REFERENCES Tests(`id`) ON DELETE CASCADE,
	CONSTRAINT fk_testusers_users FOREIGN KEY(user_id) REFERENCES Users(`id`) ON DELETE CASCADE,
	CONSTRAINT fk_testusers_devices FOREIGN KEY(device_id) REFERENCES Devices(`id`) ON DELETE SET NULL,
